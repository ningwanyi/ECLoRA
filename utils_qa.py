...
def prepare_train_dataset_qa(examples, tokenizer, max_seq_length=384, min_stride=128):
    ...
    tokenized_examples = tokenizer(
        ...
        max_length=max_seq_length,
        stride=min(max_seq_length // 2, min_stride),
...
def prepare_validation_dataset_qa(examples, tokenizer, max_seq_length=384, min_stride=32):
    questions = [q.lstrip() for q in examples["question"]]
    # max_seq_length = tokenizer.model_max_length
    tokenized_examples = tokenizer(
        questions,
